      ...
      <div className="w-full h-full bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full">
          ...
          <div className="lg:col-span-6">
            ...
            {/* Adding Solutions Box - Below Workbench */}
            <div className="mt-6 bg-white/90 backdrop-blur-sm rounded-xl p-4 border border-gray-200 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                {stepHistory.length > 0 && currentStep > 1 && (
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="bg-orange-50 border-orange-200 text-orange-700 hover:bg-orange-100 flex items-center space-x-2"
                  >
                    <Undo className="w-4 h-4" />
                    <span>Undo Step</span>
                  </Button>
              ...
              {showAddingSolutions && (
                <div className="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-200 animate-pulse">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-800">Adding solution...</h4>
                      <p className="text-sm text-blue-600">Reagent is being added to the test tube</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-3">
                {currentStep === 4 && (
                  <div className="grid grid-cols-1 gap-2">
                    <div className="bg-gray-50 rounded-lg p-3">
                      <h4 className="font-semibold text-sm text-gray-700 mb-2">Step 4: Add HCl</h4>
                      <p className="text-xs text-gray-600 mb-2">Click HCl twice to shift equilibrium to blue [CoCl₄]²⁻</p>
                      <div className="flex items-center space-x-2 text-xs">
                        <span>HCl added: {hclClickCount}/2</span>
                        <div className="flex space-x-1">
                          {[...Array(2)].map((_, i) => (
                            <div
                              key={i}
                              className={`w-2 h-2 rounded-full ${
                                i < hclClickCount ? 'bg-green-500' : 'bg-gray-300'
                              }`}
                            />
                          ))}
                        </div>
                        ...
                        <div className="flex space-x-1">
                          {[...Array(2)].map((_, i) => (
                            <div
                              key={i}
                              className={`w-2 h-2 rounded-full ${
                                i < waterClickCount ? 'bg-green-500' : 'bg-gray-300'
                              }`}
                            />
                          ))}
                        </div>
                ...
                {/* General instruction for other steps */}
                {currentStep !== 4 && currentStep !== 6 && (
                  <div className="bg-gray-50 rounded-lg p-3">
                    <h4 className="font-semibold text-sm text-gray-700 mb-1">Current Step: {currentStep}</h4>
                    <p className="text-xs text-gray-600">{GUIDED_STEPS[currentStep - 1]?.action || 'Follow the step instructions above'}</p>
                  </div>
                )}
              </div>
            </div>
