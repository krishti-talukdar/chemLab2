      ...
      return (
        <div className="relative">
          <img
            ...
            className="w-64 h-[28rem] object-contain drop-shadow-lg"
          />
  ...
  return (
    <div
      ...
      className={`flex flex-col items-center transition-all duration-300 cursor-grab active:cursor-grabbing relative ${
        isOnWorkbench
          ? "p-2 bg-white/80 border border-gray-200 shadow-md rounded-lg hover:scale-105 active:scale-95 hover:shadow-lg hover:bg-white/90" // Add background and border for better interaction on workbench
